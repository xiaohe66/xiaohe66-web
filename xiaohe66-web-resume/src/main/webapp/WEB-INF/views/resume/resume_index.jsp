        ...
        <div class="module1 projects">
            ...
            <div class="body">
                <div class="item">
                    ...
                    <div class="u_r">
                        <div class="name">恒峰校园管理系统</div>
                        <div class="desc">恒峰校园管理系统是一个……</div>
                    </div>
                </div>
                <div class="item">
                    <div class="fl">
                    ...
                    <div class="u_r">
                        <div class="name">广州粤财金融云</div>
                        <div class="desc">广州粤财金融云是一个……</div>
                    </div>
                </div>
                <div class="item">
                    <div class="fl">
                    ...
                    <div class="u_r">
                        <div class="name">703知识管理系统</div>
                        <div class="desc">XXXXXXXXXXXXXXXX是一个……</div>
                    </div>
                </div>
            </div>
        </div>
